              ...
              <div className="col-lg-8 mt-lg-0 mt-20">
                <div className="row gap-sm-0">
                  ...
                  <div className="col-md-4 col-12 mt-lg-0 mt-md-0 mt-25">
                    ...
                    <ul className="list-unstyled">
                      <li className="mb-6">
                        <a href="!#" className="text-lg color-palette-1 text-decoration-none">historegg</a>
                      </li>
                      <li className="mb-6">
                        <a href="mailto: team@store.gg" className="text-lg color-palette-1 text-decoration-none">team@store.gg</a>
                      </li>
                      <li className="mb-6">
                        <a href="http://maps.google.com/?q=Pasific 12, Jakarta Selatan" className="text-lg color-palette-1 text-decoration-none">Pacific</a>
                      </li>
                      <li className="mb-6">
